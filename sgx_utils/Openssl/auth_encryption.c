...
int auth_init(int key_size, int tag_size, int operation_mode) {
    KEY_SIZE = key_size;
...
int auth_encode(unsigned char* key, unsigned char* iv, int iv_size, unsigned char* dest, const unsigned char* src, int size, unsigned char* tag) {
    EVP_CIPHER_CTX *ctx;
    int len;
    int ciphertext_len;
...
int auth_decode(unsigned char* key, unsigned char* iv, int iv_size, unsigned char* dest, const unsigned char* src, int size, unsigned char* tag) {
    EVP_CIPHER_CTX *ctx;
    int len;
    int plaintext_len;
    int ret;
